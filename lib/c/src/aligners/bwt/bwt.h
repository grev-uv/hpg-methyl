...
typedef struct bwt_stage_bs_workspace {
  char *map_inexact_read_code_seq;
  char *map_inexact_read_seq_dup;
  char *map_inexact_read_quality_clipping;

  size_t *map_inexact_read_k1;
  size_t *map_inexact_read_l1;
  size_t *map_inexact_read_ki1;
  size_t *map_inexact_read_li1;

  array_list_t *map_inexact_read_tmp_mapping_list;
  unsigned int map_inexact_read_delete_mark[BWT_MAX_INEXACT_READ_DELETE_MARK];
} bwt_stage_bs_workspace_t;
